...
const THEMES: { id: Theme; icon: React.ReactNode; label: string }[] = [
  {
    id: "light",
    icon: <Sun className="w-3.5 h-3.5" strokeWidth={1.5} />,
    label: "Light",
  },
  {
    id: "dark",
    icon: <Moon className="w-3.5 h-3.5" strokeWidth={1.5} />,
    label: "Dark",
  },
  {
    id: "system",
...
export function ThemePicker() {
  ...
  return (
    <div
      className={`theme-picker-wrapper ${hasMounted ? "theme-picker-ready" : ""}`}
    >
